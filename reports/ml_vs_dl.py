...
if __name__ == '__main__':
    ...
    for dataset_name in DATASET_NAME_LIST:
        training_output_dir_path = '../../tmp/univariate_forecast_daily/{}'.format(dataset_name)
    ...
    for rmse_val, mae_val, mape_val, training_time, predicting_time, model_name in model_detail_list:
        if model_name in ML_MODEL_NAME_LIST:
            training_type = 'ml'
        elif model_name in DL_MODEL_NAME_LIST:
            training_type = 'dl'
